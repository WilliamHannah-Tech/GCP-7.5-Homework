  #!/bin/bash
    ...
    echo "startup script began" > /tmp/startup-ran.txt
    ...
    <body>
      ...
      <p>Deploy Banner: $STUDENT_NAME</p>
      <p>Region: $REGION Zone: $ZONE</p>
      <p>VPC: $VPC Subnet: $SUBNET</p>
    ...
    echo "startup script completed" > /var/www/html/startup-ok.txt
